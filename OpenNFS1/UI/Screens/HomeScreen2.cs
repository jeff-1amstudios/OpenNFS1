...
namespace OpenNFS1.UI.Screens
{
	...
	class HomeScreen2 : BaseUIScreen, IGameScreen
	{
		...
		public HomeScreen2() : base(false)
		{
			QfsFile qfs = new QfsFile(@"FRONTEND\ART\control\central.qfs");
			_background = qfs.Fsh.Header.Bitmaps.Find(a => a.Id == "bgnd");
			_vehicleSelection = qfs.Fsh.Header.Bitmaps.Find(a => a.Id == "Tlb1");
			_trackSelection = qfs.Fsh.Header.Bitmaps.Find(a => a.Id == "Brb4");
			_raceButtonSelection = qfs.Fsh.Header.Bitmaps.Find(a => a.Id == "Ra1l");
		...
		public void Update(GameTime gameTime)
		{
			...
			if (Engine.Instance.Input.WasPressed(Keys.Enter) && _selectedControl == RaceButtonSelected)
			{
				...
				GameConfig.SelectedTrack = _track[_currentTrack].Descriptor;
