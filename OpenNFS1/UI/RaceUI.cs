    ...
    class RaceUI
    {
       ...
       // Texture2D _backgroundTexture;
        ...
        public void Render()
        {
            ...
            msg = String.Format("[{0}]", GearToString(_race.Player.Vehicle.Motor.Gearbox.CurrentGear));
			...
			if (!GameConfig.SelectedTrack.IsOpenRoad)
            {
				msg = String.Format("Lap {0}/{1}", Math.Min(_race.PlayerStats.CurrentLap, _race.NbrLaps), _race.NbrLaps);
